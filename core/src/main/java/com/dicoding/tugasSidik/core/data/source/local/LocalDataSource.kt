package com.dicoding.tugasSidik.core.data.source.local

import com.dicoding.tugasSidik.core.data.source.local.entity.TourismEntity
import com.dicoding.tugasSidik.core.data.source.local.room.TourismDao
